( () => {
    var t = {
            ...
            window.tram = function(t) {
                ...
                function o(t, e, n) {
                    ...
                    void 0 === t)
                        return n;
                    var r = n;
                    return Y.test(t) || !Q.test(t) ? r = parseInt(t, 10) : Q.test(t) && (r = 1e3 * parseFloat(t)),
                    0 > r && (r = 0),
                    r == r ? r : n
                }
                function u(t) {
                ...
                }, p = window, h = "bkwld-tram", v = /[\-\.0-9]/g, g = /[A-Z]/, y = "number", E = /^(rgb|#)/, m = /(em|cm|mm|in|pt|pc|px)$/, _ = /(em|cm|mm|in|pt|pc|px|%)$/, b = /(deg|rad|turn)$/, O = "unitless", w = /(all|none) 0s ease 0s/, I = /^(width|height)$/, T = document.createElement("a"), A = ["Webkit", "Moz", "O", "ms"], C = ["-webkit-", "-moz-", "-o-", "-ms-"], x = function(t) {
                    if (t in T.style)
                        return {
                            dom: t,
                            css: t
                ...
                var F = e.frame = (a = p.requestAnimationFrame || p.webkitRequestAnimationFrame || p.mozRequestAnimationFrame || p.oRequestAnimationFrame || p.msRequestAnimationFrame) && S.bind ? a.bind(p) : function(t) {
                  ...
                  , L = l(function(e) {
                    ...
                    function f(t, e, r) {
                        ...
                        for (i in t)
                            u = t[i],
                            i in q ? (s.transform || (s.transform = {}),
                ...
                S.transform && S.backface && (q.z = [_, "translateZ"],
                q.rotateZ = [b],
                q.scaleZ = [y],
                q.perspective = [m]);
                var Y = /ms/
        ...
        5756: function(t, e, n) {
            "use strict";
            var r, i, o, u, a, c, s, l, f, d, p, h, v, g, y, E, m, _, b, O, w = window.$, I = n(5487) && w.tram;
        ...
        3949: function(t, e, n) {
            ...
            o.env.safari = /safari/.test(m) && !b && !O,
        ...
        7527: function(t, e, n) {
            ...
            r.define("forms", t.exports = function(t, e) {
                ...
                var u, a, c, s, l, f = {}, d = t(document), p = window.location, h = window.XDomainRequest && !window.atob, v = ".w-form", g = /e(-)?mail/i, y = /^\S+@\S+$/, E = window.alert, m = r.env();
                ...
                f.ready = f.design = f.preview = function() {
                    (function() {
                        _ && ((n = document.createElement("script")).src = "https://challenges.cloudflare.com/turnstile/v0/api.js",
                    ...
                    function() {
                        if (s = "https://webflow.com/api/v1/form/" + (a = t("html").attr("data-wf-site")),
                ...
                function w(e, n) {
                    ...
                    !u.done.attr("aria-label") && u.form.attr("aria-label", s),
                    u.done.attr("tabindex", "-1"),
                    u.done.attr("role", "region"),
                    !u.done.attr("aria-label") && u.done.attr("aria-label", s + " success"),
                    u.fail.attr("tabindex", "-1"),
                    u.fail.attr("role", "region"),
                    !u.fail.attr("aria-label") && u.fail.attr("aria-label", s + " failure");
                    var f = u.action = r.attr("action");
                    if (u.handler = null,
                    u.redirect = r.attr("data-redirect"),
                    b.test(f)) {
                        u.handler = C;
                        return
                    }
                ...
                function I(t) {
                    ...
                    t.success = !1,
                    e.prop("disabled", !!(_ && !t.turnstileToken)),
                ...
                function C(n) {
                    ...
                    o = null,
                    i = (i = c) || {},
                    r.find(':input:not([type="submit"]):not([type="file"]):not([type="button"])').each(function(e, n) {
                        var u = t(n)
                          , a = u.attr("type")
                        ...
                        o = o || function(t, e, n, r) {
                            var i = null;
                            return "password" === e ? i = "Passwords cannot be submitted." : t.attr("required") ? r ? g.test(t.attr("type")) && !y.test(r) && (i = "Please enter a valid email address for: " + n) : i = "Please fill out the required field: " + n : "g-recaptcha-response" === n && !r && (i = "Please confirm you’re not a robot."),
                            i
                        }(u, a, c, s)
                    }),
                    o);
                    ...
                    e.each(c, function(t, e) {
                        g.test(e) && (c.EMAIL = t),
                        /^((full[ _-]?)?name)$/i.test(e) && (u = t),
                        /^(first[ _-]?name)$/i.test(e) && (c.FNAME = t),
                        /^(last[ _-]?name)$/i.test(e) && (c.LNAME = t)
                    }),
                    u && !c.FNAME && (u = u.split(" "),
                    c.FNAME = u[0],
                    c.LNAME = c.LNAME || u[1]);
        ...
        1655: function(t, e, n) {
            ...
            r.define("navbar", t.exports = function(t, e) {
                var n, u, a, c, s = {}, l = t.tram, f = t(window), d = t(document), p = e.debounce, h = r.env(), v = ".w-nav", g = "w--open", y = "w--nav-dropdown-open", E = "w--nav-dropdown-toggle-open", m = "w--nav-dropdown-list-open", _ = "w--nav-link-open", b = i.triggers, O = t();
                ...
                function T(n, r) {
                    ...
                    u.button.on("click" + v, R(u)),
                    u.menu.on("click" + v, "a", F(u)),
        ...
        3946: function(t, e, n) {
            ...
            let r = n(7087)
              ...
              , R = ({actionTypeId: t=r.ActionTypeConsts.GENERAL_START_ACTION, actionListId: e, actionItemId: n, eventId: i, allowEvents: o, immediate: u, testManual: a, verbose: c, rawData: s}) => ({
                type: l,
                payload: {
                    actionTypeId: t,
                    actionListId: e,
            ...
            u.default)([W, $])
              ...
              , ta = t => (e, n) => {
                let {type: r} = e.nativeEvent
                  , i = -1 !== [B, U].indexOf(r) ? r === B : n.isActive
                  , o = {
                    ...n,
                    isActive: i
                };
            ...
            let th = {
                ...
                handler: (r = (t, e) => {
                    let {elementVisible: n} = e
                      ...
                      , {ixData: o} = i.getState()
                      , {events: u} = o;
                    return !u[r.action.config.autoStopEventId] && e.triggered ? e : r.eventTypeId === N === n ? (Y(t),
                    {
                        ...e,
                        triggered: !0
                    }) : e
        ...
        7718: function(t, e, n) {
            ...
            let r = n(7087)
              ...
              , b = (t=Object.freeze({}), e) => {
                ...
                case c:
                    {
                        let {instanceId: n, elementId: r, actionItem: i, eventId: u, eventTarget: a, eventStateKey: c, actionListId: s, groupIndex: l, isCarrier: f, origin: d, destination: p, immediate: v, verbose: g, continuous: m, parameterId: _, actionGroups: b, smoothing: O, restingValue: w, pluginInstance: I, pluginDuration: T, instanceDelay: A, skipMotion: C, skipToValue: x} = e.payload
                          , {actionTypeId: S} = i
                          , N = y(S)
                          , R = E(N, S)
        ...
        4124: function(t, e, n) {
            ...
            let {BACKGROUND: h, TRANSFORM: v, TRANSLATE_3D: g, SCALE_3D: y, ROTATE_X: E, ROTATE_Y: m, ROTATE_Z: _, SKEW: b, PRESERVE_3D: O, FLEX: w, OPACITY: I, FILTER: T, FONT_VARIATION_SETTINGS: A, WIDTH: C, HEIGHT: x, BACKGROUND_COLOR: S, BORDER_COLOR: N, COLOR: R, CHILDREN: F, IMMEDIATE_CHILDREN: P, SIBLINGS: L, PARENT: M, DISPLAY: j, WILL_CHANGE: D, AUTO: k, COMMA_DELIMITER: B, COLON_DELIMITER: U, BAR_DELIMITER: G, RENDER_TRANSFORM: V, RENDER_GENERAL: X, RENDER_STYLE: W, RENDER_PLUGIN: $} = a.IX2EngineConstants
              , {TRANSFORM_MOVE: z, TRANSFORM_SCALE: H, TRANSFORM_ROTATE: q, TRANSFORM_SKEW: Y, STYLE_OPACITY: Q, STYLE_FILTER: K, STYLE_FONT_VARIATION: Z, STYLE_SIZE: J, STYLE_BACKGROUND_COLOR: tt, STYLE_BORDER: te, STYLE_TEXT_COLOR: tn, GENERAL_DISPLAY: tr, OBJECT_VALUE: ti} = a.ActionTypeConsts
              , to = t => t.trim()
              , tu = Object.freeze({
                [tt]: S,
                [te]: N,
            ...
            function tE({config: t, event: e, eventTarget: n, elementRoot: r, elementApi: i}) {
                ...
                if (!m)
                    return [];
                let {id: _, objectId: b, selector: O, selectorGuids: w, appliesTo: I, useEventTarget: T} = ty(m);
                if (b)
            ...
            let t_ = /px/
              , tb = (t, e) => e.reduce( (t, e) => (null == t[e.type] && (t[e.type] = tF[e.type]),
            t), t || {})
              , tO = (t, e) => e.reduce( (t, e) => (null == t[e.type] && (t[e.type] = tP[e.type] || e.defaultValue || 0),
            t), t || {});
